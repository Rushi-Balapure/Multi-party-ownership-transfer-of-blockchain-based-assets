...
from deployment import BlockchainDeployment
class TransactionProcessing:
    ...
    def initiate_transaction(self, transaction_data, reconstructed_key):
        ...
        blockchaindeployment=BlockchainDeployment()
        ...
        blockchaindeployment.initiate_transaction_deploy(transaction_data, reconstructed_key)
...
def transaction_init():
    ...
    secret_key_hex = "0xffffffffffffffffffffffffffffffff"  # Example secret key in hex format
